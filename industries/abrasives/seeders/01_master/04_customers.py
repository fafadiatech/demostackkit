"""
Seeder: Customers for Alpha Abrasives.

Loads customers from data/customers.csv covering metal fabrication
workshops, auto body shops, furniture/wood workshops, stainless steel
processors, and wholesalers/resellers — buyers of both the manufactured
abrasives line and the traded machines/tools line.
