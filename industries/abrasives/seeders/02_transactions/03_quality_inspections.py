"""
Seeder: Quality Inspections for Alpha Abrasives.

Creates Incoming, In Process, and Outgoing Quality Inspections across the
manufactured wheel/disc/belt line. Uses domain-specific inspection
parameters: grit consistency, wheel balance, burst/RPM safety test, and
bond hardness. 85% pass rate for realistic demo data.
...
class QualityInspectionSeeder(BaseTransactionSeeder):
    ...
    def run(self) -> None:
        ...
        item_codes = self.ctx.cache_get("fg_item_codes", [])
