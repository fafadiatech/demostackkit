...
class WarehouseSeeder(BaseMasterSeeder):
    ...
    def run(self) -> None:
        ...
        warehouses = [
            ...
            {"warehouse_name": "Pre-delivery Inspection Bay", "parent_warehouse": f"All Warehouses - {abbr}"},
            {"warehouse_name": "Tyres & Accessories Store", "parent_warehouse": f"All Warehouses - {abbr}"},
