"""Seeder: Project Types, Task Types and Project Templates for Chemical."""
...
PROJECT_TYPES = [
    {"project_type": "Process Scale-up", "description": "Lab to plant scale-up of a new grade"},
    {"project_type": "Plant Turnaround", "description": "Planned shutdown, overhaul and restart"},
    {"project_type": "Regulatory Programme", "description": "Registration and compliance dossiers"},
]

TASK_TYPES = [
    {"name": "Lab Trial", "description": "Bench and pilot scale experimentation", "weight": 2},
    {
        "name": "Process Design",
        "description": "Mass balance, P&ID and equipment sizing",
        "weight": 3,
    },
...
TEMPLATES = [
    {
        "name": "Process Scale-up Protocol",
...
class ProjectTemplateSeeder(_ProjectTemplateSeederBase):
    label = "Chemical Project Templates"
