"""
Seeder: Customers for PowerTech Electrical Manufacturing.

Loads customers from data/customers.csv covering state electricity boards,
power utilities, EPC contractors, industrial consumers, and export partners.
