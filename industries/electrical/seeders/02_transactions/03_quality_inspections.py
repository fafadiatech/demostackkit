"""
Seeder: Quality Inspections for PowerTech Electrical Manufacturing.

Creates Incoming, In Process, and Outgoing Quality Inspections across all
electrical manufacturing items. Uses domain-specific inspection parameters
covering transformer turns ratio error, insulation resistance, HV withstand
voltage, oil breakdown voltage (BDV), and load loss. 85% pass rate for
realistic demo data.
        ...
        for _ in range(self.volume):
            ...
            for i, (spec, min_val, max_val) in enumerate(chosen_params):
                if accepted or i < n_params - 1:
                    ...
                    # Last reading of a rejected batch is out of spec
