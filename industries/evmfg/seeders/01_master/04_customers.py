"""
Seeder: Customers for Voltara EV Manufacturing.

Loads customers from data/customers.csv covering fleet operators,
dealerships, government bodies, corporate clients, and export partners.
