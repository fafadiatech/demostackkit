"""
Seeder: Suppliers for Voltara EV Manufacturing.

Loads suppliers from data/suppliers.csv covering battery cell manufacturers,
electronics and electrical component suppliers, structural part vendors,
tyre manufacturers, and packaging companies.
