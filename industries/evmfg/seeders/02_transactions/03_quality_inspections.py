"""
Seeder: Quality Inspections for Voltara EV Manufacturing.

Creates Incoming, In Process, and Outgoing Quality Inspections across all
EV manufacturing items. Uses EV-specific inspection parameters covering
battery cell voltage, insulation resistance, motor efficiency, and brake
efficiency. 85% pass rate for realistic demo data.
...
_QI_PARAMETERS = [
    ("Battery Cell Voltage (V)", 3.60, 4.20),
    ("Insulation Resistance (MOhm)", 1.00, 100.0),
