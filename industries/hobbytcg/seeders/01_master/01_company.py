"""
Seeder: Company setup for Nexus TCG & Hobbies demo.

Creates the company, fiscal year, and required Warehouse Types for a retail
hobby and trading card game store. No manufacturing warehouse types are
needed — only Transit and Stores.
