"""
Seeder: Customers for Nexus TCG & Hobbies.

Loads customers from data/customers.csv covering local walk-in retail players,
online buyers, and B2B wholesale accounts (local game stores). Pre-creates the
required customer groups: Retail Players, Online Customers, Wholesale LGS.
