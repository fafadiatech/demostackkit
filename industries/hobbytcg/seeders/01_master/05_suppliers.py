"""
Seeder: Suppliers for Nexus TCG & Hobbies.

Loads suppliers from data/suppliers.csv covering TCG distributors (ACD, Alliance,
GTS, Southern Hobby), accessories manufacturers (Ultra PRO, Arcane Tinmen),
storage/supply companies (BCW), and professional grading services (PSA).
Pre-creates the required supplier groups.
