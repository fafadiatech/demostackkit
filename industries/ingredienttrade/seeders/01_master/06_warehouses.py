...
class WarehouseSeeder(BaseMasterSeeder):
    ...
    def run(self) -> None:
        ...
        warehouses = [
            {"warehouse_name": "Mundra Depot", "parent_warehouse": f"All Warehouses - {abbr}"},
            {"warehouse_name": "Kandla Depot", "parent_warehouse": f"All Warehouses - {abbr}"},
            {
                "warehouse_name": "Chennai Regional Godown",
                "parent_warehouse": f"All Warehouses - {abbr}",
            },
            {
                "warehouse_name": "Dispatch & Staging Area",
                "parent_warehouse": f"All Warehouses - {abbr}",
            },
            {"warehouse_name": "Returns Area", "parent_warehouse": f"All Warehouses - {abbr}"},
            {
                "warehouse_name": "Quarantine Store",
                "parent_warehouse": f"All Warehouses - {abbr}",
            },
        ]
