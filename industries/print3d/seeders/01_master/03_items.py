"""
Seeder: Items for 3D Printing Services.

Loads items from data/items.csv covering FDM filaments, SLA resins,
post-processing consumables, packaging, and finished printed parts.
...
_FG_GROUPS = {"Prototypes", "Functional Parts", "Display Models"}
_RM_GROUPS = {"FDM Filaments", "SLA Resins", "Post-Processing Supplies", "Packaging"}
