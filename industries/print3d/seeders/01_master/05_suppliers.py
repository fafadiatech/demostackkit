"""
Seeder: Suppliers for 3D Printing Services.

Loads suppliers from data/suppliers.csv covering filament manufacturers,
resin suppliers, chemical distributors, and packaging companies.
