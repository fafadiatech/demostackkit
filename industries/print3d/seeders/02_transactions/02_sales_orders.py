"""
Seeder: Sales Orders for 3D Printing Services.

Generates sales orders for finished printed parts (FDM prototypes, FDM
functional parts, SLA prototypes, SLA functional parts, and SLA display
models) across the customer base. Each SO contains 1-5 randomly selected
finished goods lines with quantities between 1-20 units and rates $50-500.
