"""
Seeder: Quality Inspections for 3D Printing Services.

Creates Incoming, In Process, and Outgoing Quality Inspections across
all 3D printing items. Uses 3D-print-specific parameters: dimensional
accuracy, surface roughness, layer adhesion, and print completion.
85% pass rate for realistic demo data.
