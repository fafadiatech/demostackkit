...
FG_GROUPS = ("Solar Panels", "Inverters", "Batteries")
RM_GROUPS = ("Balance of System", "Mounting Structures", "DC Components", "AC Components")
...
"""
        ...
        self.ctx.cache_set(
            ...
            [
                ...
                for row in items
                if row.get("item_group") in RM_GROUPS
            ],
        )
